    ...
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('mustahiks.index') }}">Master {{ $title }}</a></li>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <form action="{{ route('mustahiks.update', $data->id) }}" method="post" id="formUpdate" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            @method('PUT')
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="card-tools">
                                        <a href="{{ route('mustahiks.index') }}" class="btn btn-warning"><i class="fas fa-arrow-left"></i> Kembali</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    @include('mustahiks.form', ['data' => $data])
                                </div>
            ...
            $.ajax({
                ...
                error: function (xhr) {
                    if (xhr.status === 422) {
                        ...
                        if (errors.asnaf_category) {
                            $('#asnaf_category').addClass('is-invalid').after(`<div class="invalid-feedback">${errors.asnaf_category}</div>`);
                        }
