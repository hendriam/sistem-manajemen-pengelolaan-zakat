                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="{{ route('mustahiks.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah</a>
                                </div>
                            </div>
                            <div class="card-body">
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return data ? '<span class="badge badge-success">Ya</span>' : '<span class="badge badge-danger">Belum</span>'
                    },
                    orderable: false,
                },
                {
                ...
                },
                {
                    data: null,
                    render : function(data, type, row){
                        return  '<a href="{{ route("mustahiks.index") }}/'+data.id+'/edit" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i> Edit</a> ' +
