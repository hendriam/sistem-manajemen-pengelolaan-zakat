            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('report-zakat-transactions.index') }}">{{ $title }}</a></li>
...
<script>
    const table = $('#data_table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{{ route("report-zakat-transactions.index") }}',
            type: 'POST',
            headers: {
    ...
    $('#btn-export-pdf').on('click', function() {
        ...
        let url = new URL("{{ route('report-zakat-transactions.export-pdf') }}", window.location.origin);
